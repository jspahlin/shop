...
@Entity
@Table(name="card_creature_type")
public class CardCreatureType {
	@Id
	@Column
	...
	public CardCreatureType(int id, String name) {
		super();
		this.id = id;
		this.name = name;
	}
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		CardCreatureType other = (CardCreatureType) obj;
		if (id != other.id)
			return false;
		if (name == null) {
			if (other.name != null)
	...
	public String toString() {
		return "CardCreatureType [id=" + id + ", name=" + name + "]";
	}
